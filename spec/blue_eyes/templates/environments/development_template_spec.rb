...
RSpec.describe 'development environment template' do
  let(:template_path) do
    File.expand_path(
      '../../../../lib/blue_eyes/templates/environments/development.rb.tt',
      __dir__
    )
  end
  ...
  it 'contains development-specific configuration' do
    expect(render).to match(/config\.cache_classes\s*=\s*false/)
  end
