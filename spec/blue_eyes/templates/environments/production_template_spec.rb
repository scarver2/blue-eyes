...
RSpec.describe 'production environment template' do
  let(:template_path) do
    File.expand_path(
      '../../../../lib/blue_eyes/templates/environments/production.rb.tt',
      __dir__
    )
  end
  ...
  it 'contains production-specific configuration' do
    expect(render).to match(/config\.eager_load\s*=\s*true/)
  end
